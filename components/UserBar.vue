<template>
  <v-app-bar fixed max-width="800px" class="mx-auto img">
    <v-text-field
      :value="searchPost"
    ...
    <v-dialog v-model="dialog" max-width="600px">
      ...
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          {{ imageURL }}
          <v-btn color="primary" :disabled="!postDisabled" @click="createPost">
            Publish
          </v-btn>
        </v-card-actions>
      </v-card>
...
.img {
  background-image: url('https://image.shutterstock.com/image-vector/abstract-background-hightech-technology-texture-260nw-1414333793.jpg');
